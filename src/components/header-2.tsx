  ...
  return (
    <header
      className={cn(
        ...
        {
          "border-primary/20 bg-card/70 supports-[backdrop-filter]:bg-card/50 backdrop-blur-xl md:top-4 md:max-w-4xl md:shadow-[0_8px_32px_oklch(0.68_0.28_330_/_15%)]":
            scrolled && !open,
          "bg-card/80 backdrop-blur-xl": open,
        },
      )}
    >
      <nav
      ...
      >
        ...
        <h1 className="gradient-text font-bold italic">Asad-ur-Rahman</h1>
      ...
      <div
        className={cn(
          "bg-card/80 fixed top-14 right-0 bottom-0 left-0 z-50 flex flex-col overflow-hidden border-y border-primary/20 backdrop-blur-xl md:hidden",
          open ? "block" : "hidden",
        )}
      >
        <div
