...
export function Safari({
  ...
  const hasScreenContent = hasMedia || hasChildren
  ...
  return (
    ...
    >
      ...
      {hasChildren && !hasVideo && !imageSrc && (
        ...
        >
          <div className="flex h-full w-full items-stretch justify-center bg-background/80">
            {children}
          </div>
        </div>
      )}
